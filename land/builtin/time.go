	...
	timeType.InstanceMethods.Set(
		...
		[]*ast.Method{
			ast.CreateMethod(
				...
				func(this *ast.Object, params []*ast.Object, extra map[string]interface{}) interface{} {
					tm := this.Extra["value"].(time.Time)
					return NewInteger(int64(tm.Hour()))
				},
			),
		},
	)
	timeType.InstanceMethods.Set(
		...
		[]*ast.Method{
			ast.CreateMethod(
				...
				func(this *ast.Object, params []*ast.Object, extra map[string]interface{}) interface{} {
					tm := this.Extra["value"].(time.Time)
					return NewInteger(int64(tm.Nanosecond()/1000))
				},
			),
		},
	)
	timeType.InstanceMethods.Set(
		...
		[]*ast.Method{
			ast.CreateMethod(
				...
				func(this *ast.Object, params []*ast.Object, extra map[string]interface{}) interface{} {
					tm := this.Extra["value"].(time.Time)
					return NewInteger(int64(tm.Minute()))
				},
			),
		},
	)
	timeType.InstanceMethods.Set(
		...
		[]*ast.Method{
			ast.CreateMethod(
				...
				func(this *ast.Object, params []*ast.Object, extra map[string]interface{}) interface{} {
					tm := this.Extra["value"].(time.Time)
					return NewInteger(int64(tm.Second()))
				},
			),
		},
	)
	timeType.StaticMethods.Set(
		...
		[]*ast.Method{
			ast.CreateMethod(
				...
				func(this *ast.Object, params []*ast.Object, extra map[string]interface{}) interface{} {
					hour := int(params[0].IntegerValue())
					minutes := int(params[1].IntegerValue())
					seconds := int(params[2].IntegerValue())
					milliseconds := int(params[3].IntegerValue())
