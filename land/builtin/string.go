...
func createStringType(c *ast.ClassType) *ast.ClassType {
	...
	instanceMethods.Set("repeat", []*ast.Method{
		ast.CreateMethod(
			"repeat",
			StringType,
			[]*ast.Parameter{
			...
			func(this *ast.Object, params []*ast.Object, extra map[string]interface{}) interface{} {
				count := int(params[0].IntegerValue())
				src := this.StringValue()
				
				return NewString(strings.Repeat(src, count))
			},
		),
	})
	instanceMethods.Set("indexOf", []*ast.Method{
		ast.CreateMethod(
			...
			func(this *ast.Object, params []*ast.Object, extra map[string]interface{}) interface{} {
				...
				src := this.StringValue()
				return NewInteger(int64(strings.Index(src, substring)))
			},
		),
	})
	...
	instanceMethods.Set("length", []*ast.Method{
		ast.CreateMethod(
			...
			[]*ast.Parameter{},
			func(this *ast.Object, params []*ast.Object, extra map[string]interface{}) interface{} {
				return NewInteger(int64(len(this.StringValue())))
			},
		),
	})
