		...
		[]*ast.Method{
			ast.CreateMethod(
				...
				func(this *ast.Object, params []*ast.Object, extra map[string]interface{}) interface{} {
					...
					days := int(params[0].IntegerValue())
	...
	DateType.InstanceMethods.Set(
		...
		[]*ast.Method{
			ast.CreateMethod(
				...
				func(this *ast.Object, params []*ast.Object, extra map[string]interface{}) interface{} {
					tm := this.Extra["value"].(time.Time)
					months := int(params[0].IntegerValue())
	...
	DateType.InstanceMethods.Set(
		...
		[]*ast.Method{
			ast.CreateMethod(
				...
				func(this *ast.Object, params []*ast.Object, extra map[string]interface{}) interface{} {
					tm := this.Extra["value"].(time.Time)
					years := int(params[0].IntegerValue())
	...
	DateType.InstanceMethods.Set(
		...
		[]*ast.Method{
			ast.CreateMethod(
				...
				func(this *ast.Object, params []*ast.Object, extra map[string]interface{}) interface{} {
					tm := this.Extra["value"].(time.Time)
					return NewInteger(int64(tm.Day()))
				},
			),
		},
	)
	DateType.InstanceMethods.Set(
		...
		[]*ast.Method{
			ast.CreateMethod(
				...
				func(this *ast.Object, params []*ast.Object, extra map[string]interface{}) interface{} {
					tm := this.Extra["value"].(time.Time)
					return NewInteger(int64(tm.YearDay()))
				},
			),
		},
	)
		...
		[]*ast.Method{
			ast.CreateMethod(
				...
				func(this *ast.Object, params []*ast.Object, extra map[string]interface{}) interface{} {
					...
					tm := this.Extra["value"].(time.Time)
					return NewInteger(int64(secondDate.Day() - tm.Day()))
				},
			),
		},
	)
	DateType.InstanceMethods.Set(
		...
		[]*ast.Method{
			ast.CreateMethod(
				...
				func(this *ast.Object, params []*ast.Object, extra map[string]interface{}) interface{} {
					year := int(params[0].IntegerValue())
					month := int(params[1].IntegerValue())
	...
	DateType.InstanceMethods.Set(
		...
		[]*ast.Method{
			ast.CreateMethod(
				...
				func(this *ast.Object, params []*ast.Object, extra map[string]interface{}) interface{} {
					tm := this.Extra["value"].(time.Time)
					return NewInteger(int64(tm.Month()))
				},
			),
		},
	)
		...
		[]*ast.Method{
			ast.CreateMethod(
				...
				func(this *ast.Object, params []*ast.Object, extra map[string]interface{}) interface{} {
					...
					return NewInteger(int64((sy - ty) * 12 + sm - tm))
				},
			),
		},
	)
	...
	DateType.InstanceMethods.Set(
		...
		[]*ast.Method{
			ast.CreateMethod(
				...
				func(this *ast.Object, params []*ast.Object, extra map[string]interface{}) interface{} {
					tm := this.Extra["value"].(time.Time)
					return NewInteger(int64(tm.Year()))
				},
			),
		},
	)
